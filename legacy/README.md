...
This folder contains earlier experimental work on stock prediction using
machine learning, sentiment analysis, and Streamlit applications.

This code is archived for historical reference and is **not** part of the
current empirical research pipeline described in the main repository.

The current research codebase is located in the root `src/` directory.
