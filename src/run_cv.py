...
# "ret_fwd" is the forward return used to construct "target" — it must
# never be used as a model input, or the label leaks directly into the
# features. Confirmed via diagnostic: this was leaking in every prior
# run but was masked by extreme outliers in ret_fwd until the data was
# cleaned, at which point the model began exploiting it directly
# (AUC ~0.9999 across all folds).
EXCLUDE_COLS = {
